    ...
    <footer data-nosnippet className="bg-white border-t border-slate-200 dark:bg-[#0D1117] dark:border-slate-800 py-10 transition-colors mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-slate-500">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-xs font-semibold">
          ...
          <Link href="/blog" className="hover:text-primary dark:hover:text-secondary transition-colors">ブログ</Link>
          <Link href="/terms" className="hover:text-primary dark:hover:text-secondary transition-colors">利用規約</Link>
          <Link href="/tokushoho" className="hover:text-primary dark:hover:text-secondary transition-colors">特定商取引法に基づく表記</Link>
        ...
        <div className="text-[11px]">
          &copy; 2022 - {new Date().getFullYear()} Kigyou-list. All rights reserved.
        </div>
      </div>
    </footer>
  );
