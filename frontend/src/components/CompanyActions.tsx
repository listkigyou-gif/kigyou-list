  ...
  if (!mounted) {
    return (
      <div className="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto">
        <button
          disabled
          className="inline-flex items-center justify-center gap-1.5 px-4.5 py-2.5 text-xs font-bold text-slate-400 bg-slate-100 dark:bg-slate-800 rounded-xl w-full sm:w-auto"
        >
        ...
        <button
          disabled
          className="inline-flex items-center justify-center px-5 py-2.5 text-xs font-bold text-white bg-primary/70 rounded-xl w-full sm:w-auto"
        >
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2.5 items-center w-full sm:w-auto">
      ...
      <button
        ...
        className={`inline-flex items-center justify-center gap-1.5 px-4.5 py-2.5 text-xs font-bold rounded-xl transition-all duration-300 w-full sm:w-auto ${
          isSaved
      ...
      <a
        ...
        className="inline-flex items-center justify-center gap-1.5 px-5 py-2.5 text-xs font-bold text-white bg-primary hover:bg-primary-hover rounded-xl shadow-md shadow-primary/10 hover:shadow-primary/20 transition-all duration-300 active:scale-95 w-full sm:w-auto"
      >
