  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2.5 items-center w-full sm:w-auto">
      ...
      <button
        ...
        className={`inline-flex items-center justify-center gap-1.5 px-4 py-2 text-[11px] font-medium rounded-lg transition-all duration-300 w-full sm:w-auto ${
          isSaved
      ...
      <a
        ...
        className="inline-flex items-center justify-center gap-1.5 px-4 py-2 text-[11px] font-medium text-white bg-primary hover:bg-primary-hover rounded-lg shadow-sm shadow-primary/10 hover:shadow-primary/20 transition-all duration-300 active:scale-95 w-full sm:w-auto"
      >
