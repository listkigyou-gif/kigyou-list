      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row gap-8">
        ...
        <section className="flex-1 bg-white border border-slate-200 dark:bg-[#1C2128] dark:border-slate-800 rounded-2xl p-6 md:p-10 shadow-sm flex flex-col gap-6 leading-relaxed text-sm text-slate-700 dark:text-slate-300">
          ...
          <p className="text-xs text-slate-500">
            この利用規約（以下，「本規約」といいます。）は，Kigyou-list（以下，「当サービス」といいます。）が提供する企業情報データベース検索および営業管理システム（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って本サービスをご利用いただきます。
          </p>
          ...
          <div id="art1" className="flex flex-col gap-2 pt-4 border-t border-slate-100/50 dark:border-slate-800/30">
            ...
            <p className="text-xs">
              本規約は，ユーザーと当サービスとの間の本サービスの利用に関わる一切の関係に適用されるものとします。当サービスが本サービスに関し、本規約のほかに個別規定や利用ルールを定めた場合、これらは本規約の一部を構成するものとします。
            </p>
          </div>
          ...
          <div id="art2" className="flex flex-col gap-2 pt-4 border-t border-slate-100/50 dark:border-slate-800/30">
            ...
            <p className="text-xs">
              本サービスにおいては，登録希望者が本規約に同意の上，当サービスが定める方法によって会員登録を申請し，当サービスがこれを承認することによって，会員登録が完了するものとします。
            </p>
            <p className="text-xs">
              当サービスは，登録申請者に不適切な事由があると判断した場合，登録申請を承認しないことがあり，その理由については一切の開示義務を負わないものとします。
            </p>
          </div>
          ...
          <div id="art4" className="flex flex-col gap-2 pt-4 border-t border-slate-100/50 dark:border-slate-800/30">
            ...
            <p className="text-xs">
              ユーザーは，本サービスの有料プラン（PROプラン）を利用する対価として，当サービスが定め，ウェブサイトに表示する利用料金を支払うものとします。
            </p>
            <p className="text-xs">
          ...
          <div id="art6" className="flex flex-col gap-2 pt-4 border-t border-slate-100/50 dark:border-slate-800/30">
            ...
            <p className="text-xs">
              ユーザーは，当サービス所定の手続きを経て，いつでも任意に会員登録を解除できるものとします。
            </p>
            <p className="text-xs">
              当サービスは，ユーザーが本規約のいずれかの条項に違反した場合，事前通知することなく直ちにアカウントの利用停止または強制退会の措置を取ることができるものとします。
            </p>
          </div>
          ...
          <div id="art7" className="flex flex-col gap-2 pt-4 border-t border-slate-100/50 dark:border-slate-800/30">
            ...
            <p className="text-xs">
              当サービスは，本サービスで提供するすべての情報（企業基本情報、連絡先、財務情報、営業活動シグナル等）の真実性、正確性、完全性、最新性について、明示または黙示を問わずいかなる保証も行わないものとします。
            </p>
            <p className="text-xs">
              本サービスの利用に関して発生したユーザーの損害（PCの障害、営業活動上の損失、金銭的トラブル等）について、当サービスは一切の責任を負わないものとします。
            </p>
          </div>
          ...
          <div id="art8" className="flex flex-col gap-2 pt-4 border-t border-slate-100/50 dark:border-slate-800/30">
            ...
            <p className="text-xs">
              本規約の解釈にあたっては，日本法を準拠法とします。本サービスに関して紛争が生じた場合には，当サービスの本店所在地を管轄する地方裁判所を専属的合意管轄とします。
            </p>
          </div>
        </section>
      </main>
